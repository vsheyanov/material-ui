...
var DialogInline = _react2.default.createClass({
  ...
  _getAction: function _getAction(actionJSON) {
    ...
    process.env.NODE_ENV !== "production" ? (0, _warning2.default)(false, 'using actionsJSON is deprecated on Dialog, please provide an array of\n buttons, or any other components instead. For more information please refer to documentations.') : void 0;
    var props = (_props3 = {
      secondary: true,
      onClick: actionJSON.onClick
    }, _defineProperty(_props3, 'onClick', function onClick() {
    ...
    }), _defineProperty(_props3, 'label', actionJSON.text), _defineProperty(_props3, 'style', {
      marginRight: 8
    }), _props3);
  ...
  _positionDialog: function _positionDialog() {
    ...
    var autoDetectWindowHeight = _props4.autoDetectWindowHeight;
    var autoScrollBodyContent = _props4.autoScrollBodyContent;
    var bodyStyle = _props4.bodyStyle;
    var open = _props4.open;
    var repositionOnUpdate = _props4.repositionOnUpdate;
  ...
  render: function render() {
    ...
    var actionsContainerClassName = _props5.actionsContainerClassName;
    var actionsContainerStyle = _props5.actionsContainerStyle;
    var bodyClassName = _props5.bodyClassName;
    var bodyStyle = _props5.bodyStyle;
    var children = _props5.children;
    var className = _props5.className;
    var contentClassName = _props5.contentClassName;
    var contentStyle = _props5.contentStyle;
    var overlayClassName = _props5.overlayClassName;
    var overlayStyle = _props5.overlayStyle;
    var open = _props5.open;
    var titleClassName = _props5.titleClassName;
    var titleStyle = _props5.titleStyle;
