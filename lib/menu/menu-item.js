...
var MenuItem = _react2.default.createClass({
  ...
  getInitialState: function getInitialState() {
    process.env.NODE_ENV !== "production" ? (0, _warning2.default)(false, 'This menu item component is deprecated use menus/menu-item instead.') : void 0;
  ...
  render: function render() {
    ...
    if (this.props.toggle) {
      ...
      var other = _objectWithoutProperties(_props, ['toggle', 'onClick', 'onToggle', 'onMouseEnter', 'onMouseLeave', 'children', 'style']);
